...
export function HistoryScreen() {
  ...
  return <section><div className="page-heading"><div><p className="eyebrow">{t("YOUR RECEIPTS")}</p><h1>{t("撮影履歴")}</h1></div><button className="icon-button" aria-label={t("履歴を更新")} onClick={() => load()}><RefreshCw size={20} /></button></div><p className="page-lead">{t("撮ったレシートを、いつでも確認。")}</p>
